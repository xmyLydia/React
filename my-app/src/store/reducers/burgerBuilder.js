...
const removeIngredient = (state, action) => {
    const updatedIngredientsRemove = { [action.ingredientName]: state.ingredients[action.ingredientName] + 1 }
    const updatedIngredientsRemoves = updateObject(state.ingredientName, updatedIngredientsRemove);
    const updatedStateRemove = {
        ingredients: updatedIngredientsRemoves,
        totalPrice: state.totalPrice - INGREDIENT_PRICES[action.ingredientName],
        building: true
    }
